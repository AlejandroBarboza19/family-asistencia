...
class ReportesView:
    ...
    # EXPORTAR ARCHIVO WEB (descarga directa)
        ...
        try:
            ...
            if tipo == "excel":
                datos = [{"Nombre": r["nombre"], "Cédula": r["cedula"], "Fecha": str(r["fecha"]), "Turno": r["turno"],
                          ...
                          "Tarde": r["llego_tarde"]} for r in filas]
            ...
            # Crear elemento de descarga usando JavaScript
            js_code = f"""
            (function() {{
            ...
            # Ejecutar JavaScript para descargar
            self.page.execute_script(js_code)
            
            self.mostrar_snackbar(f"✅ Descargando reporte {tipo.upper()}...", "#2E7D32")
            
        except Exception as e:
            self.mostrar_snackbar(f"❌ Error al exportar: {str(e)}", "#C62828")
